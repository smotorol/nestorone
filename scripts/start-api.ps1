param(
    ...
    [string]$ApplyMigrationsOnStartup = $(if ($env:Database__ApplyMigrationsOnStartup) { $env:Database__ApplyMigrationsOnStartup } else { 'false' })
)
...
$env:Database__ApplyMigrationsOnStartup = $ApplyMigrationsOnStartup
